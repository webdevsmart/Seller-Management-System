...
const inventory_factory = require("./routes/api/inventory_factory");
...
const oem_order = require("./routes/api/oem_order");
...
app.use("/api/inventory-factory", inventory_factory);
...
app.use("/api/oem-order", oem_order);
